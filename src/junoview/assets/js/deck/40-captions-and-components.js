/* 40-captions-and-components.js — a figure and its caption, anchoring, components, and the dialogs.
  ...
  /* ---- The QR generator was removed on 2026-09-03 (T220) --------------
     ...
     I don't know what the fuck that is, but it sucks." Roughly 240
     lines of encoder went with the door rather than staying as a
     capability nothing could reach. `git show ca39b03^` has it if a
     poster ever wants one back. Existing decks are unaffected: a QR
     was inserted as an ordinary image, so it still renders. */
