    ...
    {id:'familiar-office-ribbon',
     ...
     groups:[
      ...
      {id:'of-type',label:'Type',tab:'design',
       items:['dsg-sets','dsg-cites','dsg-stylewrap','dsg-tokens','dsg-scale-down','dsg-scale-up',
    ...
    {id:'density-everyday-first',
     ...
     groups:[
      ...
      {id:'day-look',label:'Deck look',tab:'start',
       items:['lay-drop','dsg-tidy','bg-drop','dsg-sets','dsg-cites','dsg-stylewrap','dsg-tokens']},
