    ...
    {id:'familiar-office-ribbon',
     ...
     groups:[
      ...
      {id:'of-text',label:'Text',tab:'insert',
       items:['tx-drop','dc-maths','dc-md','dc-qr']},
      {id:'of-illus',label:'Illustrations',tab:'insert',
       items:['et-image','sh-drop','dc-line','dc-draw','et-table',
      ...
      {id:'of-type',label:'Type',tab:'design',
       items:['dsg-stylewrap','dsg-tokens','dsg-scale-down','dsg-scale-up',
         'dsg-restyle','dsg-design','dsg-std']},
    ...
    {id:'scope-deck-slide-object',
     ...
     groups:[
      ...
      {id:'sl-insert',label:'Insert',tab:'slide',
       items:['tx-drop','et-image','dc-maths','dc-md','dc-qr']},
      {id:'sl-draw',label:'Draw',tab:'slide',
       items:['sh-drop','dc-line','dc-draw','et-table','et-flip',
         'et-arrow','et-cancel']},
    ...
    {id:'density-everyday-first',
     ...
     groups:[
      ...
      {id:'day-insert',label:'Insert',tab:'start',
       items:['tx-drop','et-image','sh-drop','dc-line','et-table',
         'et-flip','et-arrow','et-cancel']},
      ...
      {id:'day-deck-styling',label:'Deck styling',tab:'more',
       items:['dsg-scale-down','dsg-scale-up','dsg-restyle','dsg-design','dsg-std',
         'hm-match']},
      {id:'day-maths',label:'Other inserts',tab:'more',
       items:['dc-maths','dc-md','dc-qr','dc-draw']},
    ...
    {id:'journey-poster-first',
     ...
     groups:[
      ...
      {id:'j3-insert',label:'Insert',tab:'content',
       items:['tx-drop','et-image','dc-maths','dc-md','dc-qr','sh-drop','dc-line',
    ...
    {id:'density-one-row',
     ...
     groups:[
      ...
      {id:'one-text',label:'Text',tab:'all',
       items:['dsg-stylewrap','dsg-tokens','dsg-scale-down','dsg-scale-up',
         'dsg-restyle','dsg-design','dsg-std','fmt-stylewrap-tx','fmt-font',
     ...
     groups:[
      ...
      {id:'tt-ins',label:'Insert',tab:'tt-more',
       items:['et-table','et-flip','sh-drop','dc-line','et-arrow',
         'dc-draw','dc-maths','dc-md','dc-qr','et-cancel']},
