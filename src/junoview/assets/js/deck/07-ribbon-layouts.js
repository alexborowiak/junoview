    ...
    {id:'familiar-office-ribbon',
     ...
     groups:[
      ...
      {id:'of-pic',label:'Picture',tab:'home',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-replace','fmt-caption','fmt-imgrefresh',
    ...
    {id:'scope-deck-slide-object',
     ...
     groups:[
      ...
      {id:'ob-source',label:'Figure source',tab:'object',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-lockver','fmt-imgrefresh','fmt-replace',
    ...
    {id:'web-canvas-rail',
     ...
     groups:[
      ...
      {id:'mi-bub-fig',label:'Figure',tab:'mi-sel',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-imgrefresh','fmt-replace','fmt-caption',
