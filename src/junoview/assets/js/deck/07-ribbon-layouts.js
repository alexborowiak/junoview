/* 07-ribbon-layouts.js — many arrangements of the one ribbon: the
  ...
  function rbnLayouts(){
    return [{id:'default',name:'Default',
      blurb:'The arrangement the app ships with: Home, Insert, Design, Animation, View, and focused Style and Object tabs.',
      selTab:'style',fromMarkup:true,family:'default',
      tabs:[{id:'home',label:'Home'},{id:'images',label:'Images'},
            {id:'text',label:'Text'},
            {id:'design',label:'Design'},{id:'animation',label:'Animation'},
            {id:'view',label:'View'},{id:'present',label:'Present'},
            {id:'style',label:'Style'},{id:'object',label:'Object'}],
     ...
     groups:[
      ...
      {id:'of-font',label:'Font',tab:'home',
       items:['fmt-font','fmt-szwrap','fmt-smaller','fmt-bigger',
         ...
         'fmt-txcolwrap','fmt-txquick','fmt-stylewrap-tx','fmt-eqedit','fmt-mdedit']},
      ...
      {id:'of-draw',label:'Drawing',tab:'home',
       items:['fmt-shapewrap','fmt-fillwrap','fmt-fillcolwrap','fmt-bgquick',
         'fmt-opwrap','fmt-stylewrap','fmt-swwrap','fmt-headwrap',
         'fmt-bendwrap']},
      {id:'of-pic',label:'Picture',tab:'home',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-replace','fmt-caption','fmt-imgrefresh','fmt-imglink',
         'fmt-revert','fmt-lockver','fmt-locate','fmt-prov',
         'fmt-tablewrap','fmt-chartwrap','fmt-mediawrap','fmt-cropwrap','fmt-lockar','fmt-sizepos','fmt-parts','et-cell']},
      ...
      {id:'of-illus',label:'Illustrations',tab:'insert',
       items:['et-image','et-media','shape-strip-frame','dc-line','dc-draw','et-table',
         'et-flip','et-clone','et-arrow','et-cancel']},
      ...
      {id:'of-type',label:'Type',tab:'design',
       items:['dsg-sets','dsg-cites','dsg-stylewrap','dsg-tokens','dsg-layout','dsg-scale-down','dsg-scale-up',
    ...
    {id:'scope-deck-slide-object',
     ...
     groups:[
      ...
      {id:'sl-insert',label:'Insert',tab:'slide',
       items:['tx-strip','et-image','et-media','dc-maths','dc-md']},
      {id:'sl-draw',label:'Draw',tab:'slide',
       items:['shape-strip-frame','dc-line','dc-draw','et-table','et-flip','et-clone',
         'et-arrow','et-cancel']},
      ...
      {id:'ob-colour',label:'Colour',tab:'object',
       items:['fmt-txcolwrap','fmt-txquick','fmt-fillcolwrap','fmt-bgquick','fmt-opwrap']},
      ...
      {id:'ob-source',label:'Figure source',tab:'object',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-lockver','fmt-imgrefresh','fmt-imglink','fmt-replace',
    ...
    {id:'sources-own-tab',
     ...
     groups:[
      ...
      {id:'s1-link',label:'Notebook link',tab:'sources',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-locate','fmt-prov','fmt-replace',
         'fmt-caption','fmt-lockver','et-cell']},
      {id:'s1-fresh',label:'Freshness',tab:'sources',
       items:['fmt-imgrefresh','fmt-imglink','fmt-revert','vw-versions',
         'vw-check']},
      {id:'s1-frame',label:'Frame',tab:'sources',
       items:['et-image','et-media','fmt-tablewrap','fmt-chartwrap','fmt-mediawrap','fmt-cropwrap','fmt-lockar','fmt-sizepos',
         'fmt-parts']},
    ...
    {id:'density-everyday-first',
     ...
     groups:[
      {id:'day-slides',label:'Slides',tab:'start',
       items:['hm-newslide','hm-dupslide','hm-version','hm-main','hm-delslide','hm-laywrap',
         'vw-versions']},
      {id:'day-insert',label:'Insert',tab:'start',
       items:['tx-strip','et-image','et-media','shape-strip-frame','dc-line','et-table',
         'et-flip','et-clone','et-arrow','et-cancel']},
      {id:'day-look',label:'Deck look',tab:'start',
       items:['lay-drop','dsg-tidy','bg-drop','dsg-sets','dsg-cites','dsg-stylewrap','dsg-tokens','dsg-layout']},
      ...
      {id:'day-sources',label:'Frames and sources',tab:'format',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-replace','fmt-caption','fmt-locate',
         'fmt-prov','fmt-imgrefresh','fmt-imglink','fmt-revert','fmt-lockver',
         'fmt-parts','fmt-tablewrap','fmt-chartwrap','fmt-mediawrap','fmt-cropwrap','fmt-lockar','fmt-sizepos','et-cell']},
    ...
    {id:'journey-poster-first',
     ...
     groups:[
      ...
      {id:'j3-insert',label:'Insert',tab:'content',
       items:['tx-strip','et-image','et-media','dc-maths','dc-md','shape-strip-frame','dc-line',
         'dc-draw','et-table','et-flip','et-clone','et-arrow','et-cancel']},
      ...
      {id:'j3-arrange',label:'Arrange',tab:'content',
       items:['fmt-dup','fmt-group','fmt-ungroup','fmt-parts',
         'fmt-tablewrap','fmt-chartwrap','fmt-mediawrap','fmt-cropwrap','fmt-lockar','fmt-sizepos','fmt-alignwrap',
    ...
    {id:'density-one-row',
     ...
     groups:[
      ...
      {id:'one-insert',label:'Insert and sources',tab:'all',
       items:['tx-strip','et-image','et-media','dc-maths','dc-md','shape-strip-frame','dc-line',
         'dc-draw','fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-replace','fmt-caption','fmt-locate',
         'fmt-prov','fmt-imgrefresh','fmt-imglink','fmt-revert','fmt-lockver',
         'fmt-parts','fmt-tablewrap','fmt-chartwrap','fmt-mediawrap','fmt-cropwrap','fmt-lockar','fmt-sizepos','et-cell',
         'et-table','et-flip','et-clone','et-arrow','et-cancel']},
      ...
      {id:'one-shape',label:'Shape and colour',tab:'all',
       items:['fmt-shapewrap','fmt-stylewrap','fmt-swwrap',
         'fmt-headwrap','fmt-bendwrap','fmt-fillwrap','fmt-txcolwrap','fmt-txquick',
         'fmt-fillcolwrap','fmt-bgquick','fmt-opwrap']},
    ...
    {id:'web-canvas-rail',
     ...
     groups:[
      ...
      {id:'mi-place',label:'Place',tab:'mi-rail',
       items:['et-cell','et-image','et-media','et-table','et-flip','et-clone','dc-maths','dc-md',
         'dc-md']},
      ...
      {id:'mi-bub-fig',label:'Figure',tab:'mi-sel',
       items:['fmt-figures','fmt-flip-imgs','fmt-flip-pages','fmt-flip-own','fmt-imgrefresh','fmt-imglink','fmt-replace','fmt-caption',
         'fmt-locate','fmt-prov','fmt-revert','fmt-lockver',
         'fmt-tablewrap','fmt-chartwrap','fmt-mediawrap','fmt-cropwrap','fmt-lockar','fmt-sizepos','fmt-parts']},
    ...
    {id:'radical-ten-then-more',
     ...
     groups:[
      {id:'tt-slides',label:'Slides',tab:'tt-start',
       items:['hm-newslide','hm-dupslide','hm-version','hm-main','hm-delslide']},
      {id:'tt-add',label:'Add',tab:'tt-start',
       items:['et-cell','tx-strip','et-image','et-media']},
      ...
      {id:'tt-ins',label:'Insert',tab:'tt-more',
       items:['et-table','et-flip','et-clone','shape-strip-frame','dc-line','et-arrow',
