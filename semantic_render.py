...
/* the caption goes ABOVE its demo: read what you are about to watch,
   then watch it. Below, a caption is ambiguous — it could belong to the
   clip above or the one coming next. */
.wtour figure{margin:0;display:flex;flex-direction:column;}
.wtour figcaption{order:-1;}
